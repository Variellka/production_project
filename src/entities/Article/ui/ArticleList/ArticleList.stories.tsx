...
ListView.args = {
    articles: new Array(3).fill(article) as Article[],
    isLoading: false,
...
TileView.args = {
    articles: new Array(9).fill(article) as Article[],
    isLoading: false,
...
DarkListView.decorators = [
    ThemeDecorator(Theme.DARK),
];

export const DarkTileView = Template.bind({});
DarkTileView.args = {
    articles: new Array(9).fill(article) as Article[],
    isLoading: false,
    view: ArticleView.TILE,
};
DarkTileView.decorators = [
    ThemeDecorator(Theme.DARK),
];
